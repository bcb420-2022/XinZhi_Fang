...
![T1 Expression](./normExpr.png)
![T2 Expression](./normExpr1.png)
...
expDesign <- read.delim("/Users/cindyfang/Documents/UofT/FourthYear/BCB420/XinZhi_Fang/A1/SraRunTable.txt", sep = ",")
...
```{r, fig.cap="Heatmaps of expression values for DE genes across all patients at T1"}
...
```{r, fig.cap="Heatmaps of expression values for DE genes across all patients at T2"}
hm2 
```
...
```{r pressure, message=FALSE, fig.cap="Manhattan Plot of ORA results for all DE genes at T1"}
...
```{r, fig.cap="Manhattan Plot of ORA results for all DE genes at T2"}
gostplot(gostrestp2)
```

```{r, fig.cap="Manhattan Plot of ORA results for upregulated and downregulated genes at T1"}
gostplot(gostrestp1Up)
gostplot(gostrestp1Down)
```


```{r, fig.cap="Manhattan Plot of ORA results for upregulated and downregulated genes at T2"}
gostplot(gostrestp2Up)
gostplot(gostrestp2Down)
```

```{r, fig.cap="Manhattan Plots of ORA results for T1 and T2, using threshold of 0.001"}
